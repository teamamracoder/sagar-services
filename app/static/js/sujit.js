...
var images = document.querySelectorAll(".details-img-container");
...
images.forEach((image) => {
  ...
  image.addEventListener("mousemove", (event) => {
    ...
    image.querySelector("img").style.transform = `translate(${-(
      offsetX * scale -
      offsetX -
      translateX
    )}px, ${-(offsetY * scale - offsetY - translateY)}px) scale(${scale})`;
