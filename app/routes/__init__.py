...
# register blueprints
blueprints = [auth_bp, error_bp, user_bp, role_bp, home_bp, category_bp, product_bp, dashboard_bp, service_bp, service_type_bp, service_answer_bp, service_question_bp,product_qna_bp, cart_bp, wishlist_bp, product_review_bp, order_bp]
