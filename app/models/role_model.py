...
class RoleModel(db.Model):
    ...
    user_id = db.Column(
        db.Integer, db.ForeignKey("users.id", name="fk_users_role"), nullable=False
    )
    created_by = db.Column(
        db.Integer,
        db.ForeignKey("users.id", name="fk_users_role_created_by"),
        nullable=False,
    )
    updated_by = db.Column(
        db.Integer, db.ForeignKey("users.id", name="fk_users_role_updated_by")
    )
