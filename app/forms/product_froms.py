...
from wtforms import StringField, IntegerField, FloatField, TextAreaField, MultipleFileField, SelectField, SelectMultipleField, FileField
...
class CreateProductForm(FlaskForm):
    ...
    sort_description = TextAreaField("Sort Description", validators=[DataRequired()])
...
class AddImageForm(FlaskForm):
    product_img_urls = MultipleFileField("Image",validators=[FileRequired(),FileAllowed(['jpg', 'png', 'jpeg', 'webp','gif'])])